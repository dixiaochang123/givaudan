  ...
  <div class="shopdetails">
    ...
    <van-form @submit="onSubmit">
      ...
      <div style="margin: 16px">
        <van-button class="see" block type="info" native-type="submit">归还</van-button>
      </div>
    </van-form>
